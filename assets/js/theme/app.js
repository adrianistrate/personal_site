!function (t) {
    ...
    i.m = t, i.c = e, i.d = function (t, e, a) {
        ...
        if (i.r(a), Object.defineProperty(a, "default", {enumerable: !0, value: t}), 2 & e && "string" != typeof t) for (var n in t) i.d(a, n, function (e) {
            return t[e]
        }.bind(null, n));
        return a
    }, i.n = function (t) {
    ...
    var s = new (r(i(3)).default.GyroNorm), l = function () {
        function t() {
            !function (t, e) {
        ...
        return a(t, [{
            key: "addShader", value: function (t, e) {
            ...
            key: "start", value: function (t) {
                ...
                var n = this.gl.getUniformLocation(this.program, "image0"), o = this.gl.getUniformLocation(this.program, "image1");
            ...
            key: "mouseMove", value: function () {
                ...
                document.addEventListener("mousemove", function (e) {
                    var i = t.windowWidth / 2, a = t.windowHeight / 2;
    ...
    !function (t) {
        ...
        if (void 0 === t.FULLTILT || null === t.FULLTILT) {
            var r = Math.PI, s = r / 2, l = 2 * r, c = r / 180, h = 180 / r, u = {orientation: {active: !1, callbacks: [], data: void 0}, motion: {active: !1, callbacks: [], data: void 0}},
                m = !(!t.screen || !t.screen.orientation || void 0 === t.screen.orientation.angle || null === t.screen.orientation.angle),
                d = (m ? t.screen.orientation.angle : t.orientation || 0) * c, v = s, g = r, f = l / 3, p = -s, y = {
                    version: "0.5.3", getDeviceOrientation: function (t) {
            ...
            y.Quaternion.prototype = {
                constructor: y.Quaternion, multiplyQuaternions: function () {
                    var t = new y.Quaternion;
                    return function (e, i) {
                        var a = e.x, n = e.y, o = e.z, r = e.w, s = i.x, l = i.y, c = i.z, h = i.w;
                    ...
                    var t, e, i = new y.Quaternion, a = new y.Quaternion;
                ...
                constructor: y.RotationMatrix, multiplyMatrices: function () {
                    ...
                    var e = t.elements, i = e[0] * e[4] * e[8] - e[0] * e[5] * e[7] - e[1] * e[3] * e[8] + e[1] * e[5] * e[6] + e[2] * e[3] * e[7] - e[2] * e[4] * e[6];
                    return e[0] /= i, e[1] /= i, e[2] /= i, e[3] /= i, e[4] /= i, e[5] /= i, e[6] /= i, e[7] /= i, e[8] /= i, t.elements = e, t
                }, rotateByAxisAngle: function () {
                    var t, e, i = new y.RotationMatrix, a = new y.RotationMatrix, n = !1;
                ...
                this.set = function (t, e, i) {
                    ...
                    var t, e, i;
                    return function (a) {
                        var n = a.w * a.w, o = a.x * a.x, c = a.y * a.y, u = a.z * a.z, m = n + o + c + u, d = a.w * a.x + a.y * a.z;
                        if (d > .499999 * m) t = 2 * Math.atan2(a.y, a.w), e = s, i = 0; else if ((1e-6 - .5) * m > d) t = -2 * Math.atan2(a.y, a.w), e = -s, i = 0; else {
                            var v = n - o + c - u, g = 2 * (a.w * a.z - a.x * a.y), f = n - o - c + u, p = 2 * (a.w * a.y - a.x * a.z);
                ...
                constructor: y.Euler, rotateByAxisAngle: function () {
                ...
                constructor: y.DeviceOrientation, start: function (e) {
                    ...
                    var t = new y.Euler, e = new y.RotationMatrix, i = new y.Quaternion;
                    return function () {
                        var a = u.orientation.data || {alpha: 0, beta: 0, gamma: 0}, n = a.alpha;
                    ...
                    var t = new y.Euler, e = new y.RotationMatrix;
                    return function () {
                        var i = u.orientation.data || {alpha: 0, beta: 0, gamma: 0}, a = i.alpha;
                ...
                getScreenAdjustedAcceleration: function () {
                    var t = u.motion.data && u.motion.data.acceleration ? u.motion.data.acceleration : {x: 0, y: 0, z: 0}, e = {};
                    switch (d) {
                        case v:
                            e.x = -t.y, e.y = t.x;
                            break;
                ...
                getScreenAdjustedAccelerationIncludingGravity: function () {
                    var t = u.motion.data && u.motion.data.accelerationIncludingGravity ? u.motion.data.accelerationIncludingGravity : {x: 0, y: 0, z: 0}, e = {};
                    switch (d) {
                        case v:
                            e.x = -t.y, e.y = t.x;
                            break;
                ...
                getScreenAdjustedRotationRate: function () {
                    var t = u.motion.data && u.motion.data.rotationRate ? u.motion.data.rotationRate : {alpha: 0, beta: 0, gamma: 0}, e = {};
                    switch (d) {
                        case v:
        ...
        GyroNorm: function () {
            ...
            function e() {
                ...
                var i = g.getScreenAdjustedAcceleration(), n = g.getScreenAdjustedAccelerationIncludingGravity(), o = g.getScreenAdjustedRotationRate(), r = 0;
            ...
            var a = "game", n = "world", o = "deviceorientation", r = "acceleration", s = "accelerationinludinggravity", l = "rotationrate", c = null, h = 0, u = 0, m = !1, d = !1, v = null, g = null,
                f = 50, p = !0, y = a, A = 2, x = null, b = !1, E = function (t) {
                };
            return E.GAME = a, E.WORLD = n, E.DEVICE_ORIENTATION = o, E.ACCELERATION = r, E.ACCELERATION_INCLUDING_GRAVITY = s, E.ROTATION_RATE = l, E.prototype.init = function (t) {
                ...
                var e = v.getScreenAdjustedEuler(), i = g.getScreenAdjustedAcceleration(), a = g.getScreenAdjustedAccelerationIncludingGravity(), n = g.getScreenAdjustedRotationRate();
                switch (t) {
                    case o:
